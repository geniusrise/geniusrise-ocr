...
class FineTunePix2Struct(Bolt):
    ...
    def process(
        ...
        model = Pix2StructForConditionalGeneration.from_pretrained(self.model_name).to(device)
        processor = Pix2StructProcessor.from_pretrained(self.model_name)
